...
MIGRATION_MODULES = {
    'sites': 'performance_test.contrib.sites.migrations'
}
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = 'performance_test.users.adapters.AccountAdapter'
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = 'performance_test.users.adapters.SocialAccountAdapter'
